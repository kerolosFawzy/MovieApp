...
//            mMovie.setVote_count(mynewob.getString("vote_average"));
//            mMovie.setOriginal_title(mynewob.getString("original_title"));
//            mMovie.setPoster_path(mynewob.getString("poster_path"));
//            mMovie.setOverview(mynewob.getString("overview"));
//            mMovie.setRelease_date(mynewob.getString("release_date"));
